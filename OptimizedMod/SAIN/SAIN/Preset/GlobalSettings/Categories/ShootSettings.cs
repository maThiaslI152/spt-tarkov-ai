...
public class ShootSettings : SAINSettingsBase<ShootSettings>, ISAINSettings
{
    ...
    [Name("Raider Engagement Distance Multiplier")]
    [Description(
        "Multiplier applied to engagement distance for Raiders (pmcBot / Labs raiders). "
            + "Raiders use the PMC brain but tend to sneak too close. "
            + "2.0 = double engagement distance, making them engage from further away. "
            + "Only active in 'My Tuned Preset'."
    )]
    [MinMax(1f, 5f, 1f)]
    [Category("Bot Weapon Control")]
    [Advanced]
    public float RaiderEngagementDistanceMultiplier = 1f;
