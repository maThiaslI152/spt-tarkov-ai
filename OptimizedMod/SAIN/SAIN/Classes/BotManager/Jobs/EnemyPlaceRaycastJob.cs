        ...
        while (!_disposed)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    EnemyPlaceJob.PlacePositions[i] = Place.Position;
                    EnemyPlaceJob.BotPositions[i] = Place.PlaceData.Owner.Transform.EyePosition;
                    EnemyPlaceJob.EnemyPositions[i] = Place.PlaceData.OwnerEnemy.EnemyTransform.Position;
                }
